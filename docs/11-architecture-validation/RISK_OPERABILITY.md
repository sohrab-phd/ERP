...
A Phase 11 **structure** restatement of residual risk. Named operators
and unaccepted packages stay open. OQ-016 RPO/RTO are recorded;
retention days remain residual.
...
| RISK-010 backups cannot restore | Restore: Balance from Ledger; Genealogy from DATA-GEN-001 source facts | OQ-016 residual retention/product. RPO/RTO recorded. |
| RISK-011 Finance-Lite expansion | ASM-010; export only | OQ-012 recorded: not legal GL |
...
The design stays one Node.js + TypeScript Modular Monolith with module
labels (ADR-0006 accepted), not a microservices mesh. Agent implementation
...
- Retention days / backup product (OQ-016 residual)
- Headcount
