...
depends_on: [APP-MOD-001, GOV-DOMAIN-001, APR-010]
...
| `host-backend` | Command/query backend process kind | Trust `ZONE-UI` |
| `host-worker` | APP-BG-001 kinds | Second stock writer |
| `host-adapter` | Adapter host | Direct table writes |
| `ui-operator` | Shop-floor / office UI | Authorize by UI-claimed role |
